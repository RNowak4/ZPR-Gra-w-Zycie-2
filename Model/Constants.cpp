...
const double Constants::MAX_SIMULATION_SPEED = 5.0;
...
const unsigned Constants::DEFAULT_HERBIVORE_YOUTH_LEN = 150;
...
const double Constants::DEFAULT_HERBIVORE_EATING_SIGHT_REDUCTION = 2.5;
const double Constants::DEFAULT_HERBIVORE_SLEEPING_SIGHT_REDUCTION = 3.0;
...
const unsigned Constants::DEFAULT_CARNIVORE_YOUTH_LEN = 125;
