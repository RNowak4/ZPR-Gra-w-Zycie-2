...
newAttributes.strength_ = (this->strength_ + secondAttributes.strength_) / 2.0
...
newAttributes.sickChance_ = (this->sickChance_ + secondAttributes.sickChance_)
		/ 2.0 + mutationDistribution(generator);

newAttributes.sightAngle_ = (this->sightAngle_ + secondAttributes.sightAngle_)
		/ 2.0 + (mutationDistribution(generator) * 360.0 / 20.0);

newAttributes.sightLength_ =
		(this->sightLength_ + secondAttributes.sightLength_) / 2.0
